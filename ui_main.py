...
# Form implementation generated from reading ui file 'ui_main_v2.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_text_GPA_budget9 = ("09.02.03 ПРОГРАММИРОВАНИЕ В КОМПЬЮТЕРНЫХ СИСТЕМАХ",
        ...
        self.lbl_text_GPA_paid9 = ("09.02.03 ПРОГРАММИРОВАНИЕ В КОМПЬЮТЕРНЫХ СИСТЕМАХ",
                                   "09.02.04 ИНФОРМАЦИОННЫЕ СИСТЕМЫ (ПО ОТРАСЛЯМ)",
                                   "09.02.07 ИНФОРМАЦИОННЫЕ СИСТЕМЫ И ПРОГРАММИРОВАНИЕ",
                                   "10.02.01 ОРГАНИЗАЦИЯ И ТЕХНОЛОГИЯ ЗАЩИТЫ ИНФОРМАЦИИ",
                                   "10.02.04 ОБЕСПЕЧЕНИЕ ИНФОРМАЦИОННОЙ БЕЗОПАСНОСТИ ТЕЛЕКОММУНИКАЦИОННЫХ СИСТЕМ",
        ...
        self.lbl_text_GPA_budget11 = ("09.02.03 ПРОГРАММИРОВАНИЕ В КОМПЬЮТЕРНЫХ СИСТЕМАХ",
                                      "09.02.04 ИНФОРМАЦИОННЫЕ СИСТЕМЫ (ПО ОТРАСЛЯМ)",
                                      "09.02.07 ИНФОРМАЦИОННЫЕ СИСТЕМЫ И ПРОГРАММИРОВАНИЕ",
                                      "10.02.01 ОРГАНИЗАЦИЯ И ТЕХНОЛОГИЯ ЗАЩИТЫ ИНФОРМАЦИИ",
                                      "10.02.04 ОБЕСПЕЧЕНИЕ ИНФОРМАЦИОННОЙ БЕЗОПАСНОСТИ ТЕЛЕКОММУНИКАЦИОННЫХ СИСТЕМ",
        ...
        self.lbl_text_GPA_paid11 = ("09.02.03 ПРОГРАММИРОВАНИЕ В КОМПЬЮТЕРНЫХ СИСТЕМАХ",
                                    "09.02.04 ИНФОРМАЦИОННЫЕ СИСТЕМЫ (ПО ОТРАСЛЯМ)",
                                    "09.02.07 ИНФОРМАЦИОННЫЕ СИСТЕМЫ И ПРОГРАММИРОВАНИЕ",
                                    "10.02.01 ОРГАНИЗАЦИЯ И ТЕХНОЛОГИЯ ЗАЩИТЫ ИНФОРМАЦИИ",
                                    "10.02.04 ОБЕСПЕЧЕНИЕ ИНФОРМАЦИОННОЙ БЕЗОПАСНОСТИ ТЕЛЕКОММУНИКАЦИОННЫХ СИСТЕМ",
        ...
        for i in range(self.SIZE_GRADE_POINT_AVERAG_PAID_9):
    ...
    def retranslateUi(self, MainWindow):
        ...
        for i in range(self.SIZE_GRADE_POINT_AVERAG_BUDGET_9):
            self.lst_label_GPA_budget9[i].setText(_translate("MainWindow", self.lbl_text_GPA_budget9[i]))
            self.mas_GPA_budget9[i].setPlaceholderText(_translate("MainWindow", "100"))

        # GPA_PAID 9 classes
        for i in range(self.SIZE_GRADE_POINT_AVERAG_BUDGET_9):
            self.lst_label_GPA_paid9[i].setText(_translate("MainWindow", self.lbl_text_GPA_paid9[i]))
            self.mas_GPA_paid9[i].setPlaceholderText(_translate("MainWindow", "100"))

        # GPA_BUDGET 11 classes
        for i in range(self.SIZE_GRADE_POINT_AVERAG_BUDGET_9):
            self.lst_label_GPA_budget11[i].setText(_translate("MainWindow", self.lbl_text_GPA_budget11[i]))
            self.mas_GPA_budget11[i].setPlaceholderText(_translate("MainWindow", "100"))

        # GPA_PAID 11 classes
        for i in range(self.SIZE_GRADE_POINT_AVERAG_BUDGET_9):
            self.lst_label_GPA_paid11[i].setText(_translate("MainWindow", self.lbl_text_GPA_paid11[i]))
            self.mas_GPA_paid11[i].setPlaceholderText(_translate("MainWindow", "100"))
