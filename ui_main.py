...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_input_btn = QtWidgets.QFrame(self.page_input)
        self.frame_input_btn.setMinimumSize(QtCore.QSize(0, 100))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        self.frame_input_btn.setFont(font)
        self.frame_input_btn.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frame_input_btn.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frame_input_btn.setObjectName("frame_input_btn")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.frame_input_btn)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.btn_input_save = QtWidgets.QPushButton(self.frame_input_btn)
        ...
        self.btn_input_next = QtWidgets.QPushButton(self.frame_input_btn)
        ...
        self.verticalLayout_7.addWidget(self.frame_input_btn, 0, QtCore.Qt.AlignRight)
        ...
        self.horizontalLayout_3.addWidget(self.sc)
        ...
        self.checkBox_correlation = QtWidgets.QCheckBox(self.frame_graph_indicator)
        self.checkBox_correlation.setObjectName("checkBox_correlation")
        self.verticalLayout_11.addWidget(self.checkBox_correlation)
        ...
        self.frame_graph_btn.setMinimumSize(QtCore.QSize(0, 100))
        self.frame_graph_btn.setMaximumSize(QtCore.QSize(16777215, 16777215))
    ...
    def retranslateUi(self, MainWindow):
        ...
        # Graphic Page
        self.lbl_indicator.setText(_translate("MainWindow", "<b>Показать на графике:<b>"))
        self.checkBox_correlation.setText(_translate("MainWindow", "Корреляция"))
        ...
        self.checkBox_correlation.setChecked(1)
        self.checkBox_budget.setChecked(1)
        self.checkBox_paid.setChecked(1)
        ...
        # Валидатор панели "ввод данных"
        self.setValidator()

        # Таблица панели "график"
        self.tableWidget.setHorizontalHeaderLabels(["Код", "Специальность"])
        for i in range(len(self.lbl_text_GPA)):
            self.tableWidget.setItem(i, 0, QTableWidgetItem(self.lbl_text_GPA[i].split()[:1][0]))
            self.tableWidget.setItem(i, 1, QTableWidgetItem(' '.join(self.lbl_text_GPA[i].split()[1:])))
